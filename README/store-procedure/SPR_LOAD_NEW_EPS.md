``` sql
CREATE PROCEDURE [PM].[SPR_LOAD_NEW_EPS]
AS
BEGIN TRY
  ...
  SET @ConsultCursor = CURSOR FOR SELECT LNE.CodePreauthorization, LNE.Metadata, P.Id, LNE.DocumentId, LNE.DocumentType, LNE.DeliveryDate, LNE.CreateDate, LNE.[TimeStamp]
