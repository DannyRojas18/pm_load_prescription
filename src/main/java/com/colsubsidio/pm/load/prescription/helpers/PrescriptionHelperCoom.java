 ...
 */
@Component
public class PrescriptionHelperCoom {
    ...
    @Autowired
    public PrescriptionHelperCoom( LogsManager log, TreatmentCoomDao treatmentDao,
                                   MedicalPrescriptionCoomDao medicalPrescriptionDao, FieldValidatorDao fieldValidatorDao ) {
        this.log = log;
    ...
    public void createMedicalPrescription( JsonElement jsonElement, EEps eps ) {

        MedicalPrescriptionCoom medicalPrescription;
        ...
        medicalPrescription = new MedicalPrescriptionCoom();
        medicalPrescription.setEpsNit( nit );
        medicalPrescription.setMipresNumber( mipresNumber );
        medicalPrescription.setIdPrescriptionSource( EPrescriptionSource.COOM.getId() );
    ...
    public void createTreatment( JsonElement jsonElement, MedicalPrescriptionCoom medicalPrescription ) {
        ...
        gson = new Gson();
        idMedicalPrescription = medicalPrescription.getIdMedicalPrescriptionCoomeva();
        ...
        treatment = new TreatmentCoom();
        treatment.setIdMedicalPrescriptionCoomeva( idMedicalPrescription );
    ...
    public void updateTreatmentFromMetadata( JsonElement jsonElement, TreatmentCoom treatment ) {
        ...
        if( EFormulaState.NO_ENTREGADO.getId().equals( currentFormulaState ) ) {
            ...
            log.trace( "Status will not changed because the formula state is differente of NOT DELIVERY. " +
                       "Id: ", treatment.getIdTreatmentCoomeva() );
        }
    ...
    public void createTreatmentAddressing( JsonElement jsonElement, MedicalPrescriptionCoom medicalPrescription ) {
        TreatmentCoom treatment;
    ...
    public void updateTreatmentAddressing( JsonElement jsonElement, TreatmentCoom treatment ) {
