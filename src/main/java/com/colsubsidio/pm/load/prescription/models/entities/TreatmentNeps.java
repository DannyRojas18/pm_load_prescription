...
@Data
@Entity
@Table( name = "treatmentneps" )
public class TreatmentNeps {
    ...
    @Column( name = "idtreatmentneps" )
    private String idTreatmentNeps;

    @Column( name = "idmedicalprescriptionneps" )
    private String idMedicalPrescriptionNeps;
